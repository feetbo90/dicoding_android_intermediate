...
class HomeViewModelTest {
    ...
    fun `get all stories successfully`() = runTest {
        ...
        Mockito.`when`(homeViewModel.getStoriesTwo(dummyToken)).thenReturn(stories)

        val actualStories = homeViewModel.getStoriesTwo(dummyToken).getOrAwaitValue()
        ...
        Mockito.verify(homeViewModel).getStoriesTwo(dummyToken)
